...
{
    echo '<script>alert("Submit is working")</script>';
    ...
    if (file_exists($target_file)) {
      ...
      // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            $query.=mysqli_query($con, "UPDATE tblmedicalhistory
            SET MedicalPres='$target_file' WHERE PatientID='$vid'");
            if ($query){
...
while ($row=mysqli_fetch_array($ret)) { 
  ?>
                            ...
                            <span align="center">
                                <button class="btn btn-warning waves-effect waves-light w-lg" data-toggle="modal"
                                    data-target="#myModal">Add Medical History</button>
                            </span>
                            <span align="center">
                                <button class="btn btn-warning waves-effect waves-light w-lg" data-toggle="modal"
                                    data-target="#myModal2">Upload prescription</a></button>
                            </span>
                                            ...
                                            <table class="table table-bordered table-hover data-tables">
                                                ...
                                                <form method="post" name="submit">
                                                    ...
                                                    <tr>
                                                        <th>Body Temperature :</th>
                                                        <td>
                                                            <input name="temp" placeholder="Temperature"
                                                                class="form-control wd-450" required="true">
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-bordered table-hover data-tables">
                                                ...
                                                <form method="post" name="submit2" enctype="multipart/form-data">
                                                    <tr>
                                                        <th>Upload File</th>
                                                        <td>
                                                            <input type="file" name="fileToUpload" id="fileToUpload"
                                                                class="form-control wd-450" required="true"><br>
                                                            <p><strong>Note:</strong> Only jpg,jpeg,pdf,png formats
                                                                allowed .</p>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Close</button>
                                            <button type="submit" name="submit2" class="btn btn-warning">Submit</button>
