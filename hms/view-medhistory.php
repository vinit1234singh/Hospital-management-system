        ...
        <div class="main" style="flex-grow:8">
            <div class="container text-center">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle fw-bold my-5">Users | Medical History</h1>
                        </div>
                    </div>
                </section>
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15 fw-bold my-3">Users <span class="text-bold">Medical
                                    History</span>
                            </h5>
                            <?php
                               $vid=$_GET['viewid'];
...
while ($row=mysqli_fetch_array($ret)) { 
  ?>
                                <tr>
                                    ...
                                    <td><?php  
                                    if($row['MedicalPres']!="")
                                      echo "<a href=doctor/".$row['MedicalPres']." download >Download</a>";
                                      else
                                      echo 'Not Uploaded';
                                      ?>
                                    </td>
